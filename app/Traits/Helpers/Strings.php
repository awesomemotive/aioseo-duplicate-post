...
trait Strings {
	 ...
	 * @param  int    $length The maximum length allowed for the string.
	 * @param  string $append Append this to the end of the string if it's truncated.
	 * @return string $text   The truncated string.
	 */
	public function truncateString( $string, $length = 550, $append = '...' ) {
